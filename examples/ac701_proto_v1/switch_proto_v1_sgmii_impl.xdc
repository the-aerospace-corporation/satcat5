...
# 25 MHz clock references (from SJA1105 or external source)
create_clock -period 40.0 -name clk_sja [get_ports sja_clk25]
...
set_clock_groups -asynchronous \
    -group [get_clocks clk_sja      -include_generated_clocks] \
...
set_max_delay 1.5 -from synth_625a -to synth_125a -datapath_only
set_max_delay 1.5 -from synth_125a -to synth_625a -datapath_only
