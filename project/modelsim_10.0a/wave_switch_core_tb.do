...
add wave -noupdate /switch_core_tb/uut/pktout_commit
add wave -noupdate /switch_core_tb/uut/pktout_revert
...
add wave -noupdate -radix hexadecimal /switch_core_tb/uut/gen_input(0)/u_frmchk/len_field
