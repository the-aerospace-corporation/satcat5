...
set constr_synth "constraints/router_ac701_synth.xdc"
set constr_impl "constraints/router_ac701_impl.xdc"

# There's no source in this project except the IP-cores!
set files_main ""

# Run the main project-creation script.
source shared_create.tcl

# Add the folder where the SatCat5 cores should be installed.
set_property ip_repo_paths [file normalize ipcores] [current_project]
update_ip_catalog

# If they don't already exist, create them now.
set ipcount [llength [get_ipdefs *satcat5*]]
if {$ipcount eq 0} {
    puts "Installing SatCat5 IP-cores."
    source create_all_ipcores.tcl
} else {
