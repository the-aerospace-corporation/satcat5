...
set constr_synth "constraints/converter_zed_synth.xdc"
set constr_impl "constraints/converter_zed_impl.xdc"
...
set files_main [list \
 ...
 "[file normalize "../../src/vhdl/xilinx/converter_zed_top.vhd"]"\
]
