...
proc ipcore_add_reset { rst_name polarity } {
    global ip
...
proc ipcore_add_axilite { label clk rst pname } {
    global ip
    ...
    ipx::add_memory_map $label $ip
    set_property slave_memory_map_ref $label $intf
    ipx::add_address_block ${label}_addr [ipx::get_memory_maps $label]
}
...
proc ipcore_add_param { param_name param_type param_default } {
    ...
    # Special formatting for bit-strings.
