...
namespace satcat5 {
    namespace cfg {
        ...
        // (e.g., cfgbus_readonly, cfgbus_readonly_sync)
        class GpiRegister {
        public:
        ...
        // (e.g., cfgbus_register, cfgbus_register_sync)
        class GpoRegister {
        public:
            ...
            // Set or clear the masked bit(s).
            void mask_clr(u32 mask);
            void mask_set(u32 mask);
