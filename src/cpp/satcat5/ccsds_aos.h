...
namespace satcat5 {
    namespace ccsds_aos {
        ...
        constexpr u16 VCID_IDLE     = 0x003F;   // Virtual channel: Only idle data (OID)

        //! CCSDS-AOS transfer frame header.  \see ccsds_aos.h.
        ...
        //! \see ccsds_aos.h, ccsds::Dispatch.
        //! A "channel" object represents a single virtual channel, bound
        //! to a unique Satellite ID and Virtual Channel ID.  It may be
        //! configured in M_PDU (SPP packets) or B_PDU (byte-stream) mode.
        //! Each channel requires its own transmit and receive buffers,
        //! which are not provided as part of this object.
        class Channel final
        ...
        //! \see ccsds_aos.h, ccsds::Channel, ccsds::DispatchStatic.
        class Dispatch
            : public satcat5::io::EventListener
        ...
        public:
            ...
            Dispatch(
                satcat5::io::Readable* src,     // Receive interface
                satcat5::io::Writeable* dst,    // Transmit interface
            ...
            inline const satcat5::ccsds_aos::Header& rcvd_hdr() const
                { return m_rcvd_hdr; }      //!< Most recent received header
