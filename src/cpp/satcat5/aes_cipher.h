...
// encryption of 16-byte blocks in electronic-code-book (ECB) mode only.
...
// AES-256: Ciphertext encryption: throughput of 488.637268 Mbps. 47.478981 clock cycles per byte.
//          sub_bytes 1.271469, shift_rows 0.502606, MixCols 1.246638, add_round_key 0.290000 clock cycles per byte.
// AES-192: Ciphertext encryption: throughput of 570.453186 Mbps. 40.669419 clock cycles per byte.
//          sub_bytes 0.951200, shift_rows 0.502788, MixCols 1.245912, add_round_key 0.290000 clock cycles per byte.
// AES-128: Ciphertext encryption: throughput of 685.345886 Mbps. 33.851519 clock cycles per byte.
//          sub_bytes 0.951925, shift_rows 0.502788, MixCols 1.247906, add_round_key 0.289819 clock cycles per byte.
//
// LUTs are used for the GF multiplication and "sbox" functions, but the
// sub_bytes, row shifting, and column mixing are implemented using array
// manipulations. If increased throughput is desired, then these functions
// can be LUT'd, e.g. as in openssl (https://www.openssl.org/) or replaced
// with hardware instructions.
//
// This implementation was derived from the Tiny-AES library:
