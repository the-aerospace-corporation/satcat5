...
namespace satcat5 {
    namespace coap {
        ...
        constexpr Code                  // Response codes (Section 12.1.2)
            ...
            CODE_CONTINUE       (2,31), //!< 2.31 Continue
        ...
        constexpr u16
            OPTION_IF_MATCH     = 1,    //!< Option: If-Match
            OPTION_URI_HOST     = 3,    //!< Option: Uri-Host
            OPTION_ETAG         = 4,    //!< Option: ETag
            OPTION_IF_NONE      = 5,    //!< Option: If-None-Match
            OPTION_URI_PORT     = 7,    //!< Option: Uri-Port
            OPTION_LOC_PATH     = 8,    //!< Option: Location-Path
            OPTION_URI_PATH     = 11,   //!< Option: Uri-Path
            OPTION_FORMAT       = 12,   //!< Option: Content-Format
            OPTION_MAX_AGE      = 14,   //!< Option: Max-Age
            OPTION_URI_QUERY    = 15,   //!< Option: Uri-Query
            OPTION_ACCEPT       = 17,   //!< Option: Accept
            OPTION_LOC_QUERY    = 20,   //!< Option: Location-Query
            OPTION_BLOCK2       = 23,   //!< Option: Block transfer (RFC7959)
            OPTION_BLOCK1       = 27,   //!< Option: Block transfer (RFC7959)
            OPTION_PROXY_URI    = 35,   //!< Option: Proxy-Uri
            OPTION_PROXY_SCH    = 39,   //!< Option: Proxy-Scheme
            OPTION_SIZE1        = 60;   //!< Option: Size1
