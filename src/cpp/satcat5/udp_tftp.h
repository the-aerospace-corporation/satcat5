...
namespace satcat5 {
    namespace udp {
        ...
        //! \see udp_tftp.h, udp::TftpServerCore.
        ...
        //! \see udp_tftp.h, udp::TftpServerSimple, udp::TftpClientPosix.
        ...
        public:
            //! Attach this server to a network interface,
            //! and to a source and sink for transfered data.
            TftpServerSimple(
