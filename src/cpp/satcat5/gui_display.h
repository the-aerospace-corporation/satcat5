...
namespace satcat5 {
    namespace gui {
        ...
        public:
            ...
            // Set cursor parameters for subsequent commands:
            bool color_fg(u32 color);   // Foreground color
            bool color_bg(u32 color);   // Background color
            bool cursor(u16 r, u16 c);  // Move cursor to position
            ...
            // Draw a solid rectangle using the specified color, using
            // with cursor position as the upper-left corner.
        ...
        // Color parameters for the LogToDisplay class (see below).
