...
namespace satcat5 {
    namespace device {
        namespace pll {
            ...
            //!
            //! References:
            //!  * https://docs.xilinx.com/r/en-US/ug1437-clk104
            //!  * https://www.ti.com/product/LMK04828
            ...
            public:
                ...
                static constexpr u8 REF_EXT  = 0; //!< ref_sel = INPUT_REF (J11)
                static constexpr u8 REF_TCXO = 1; //!< ref_sel = TCXO (U4)
                static constexpr u8 REF_FPGA = 2; //!< ref_sel = SFP_REC_CLK

                //! Start configuration process.
                //! \param ref_sel Input select, \see REF_EXT, REF_TCXO, REF_FPGA.
                //! \param ref_hz Reference clock frequency.
                //! \param verbose Enable additional diagnostics.
                void configure(
